...
import 'package:bhbbites/widgets/custom_dialog.dart';
         ...
         child: Padding(
           ...
           child: Column(
             children: <Widget>[
               ...
               AutoSizeText(
                 "Never run out of meal ideas for your kids",
                 maxLines: 2,
                 textAlign: TextAlign.center,
                 style: TextStyle(
                     fontSize: 30,
                   ...
                   RaisedButton(
                     ...
                     onPressed: () {
                       showDialog(
                           ...
                           description: "With an account, your data will be securely saved, allowing",
